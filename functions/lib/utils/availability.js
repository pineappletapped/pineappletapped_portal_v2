...
export function exclusiveIntervalsOverlap(requestStart, requestEnd, bookingStart, bookingEnd) {
...
export function bookingConflictsWithRange(booking, requestStart, requestEnd) {
    if (!booking) {
        return false;
    }
